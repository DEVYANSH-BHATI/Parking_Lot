...
class ChargesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create charge" do
    assert_difference("Charge.count") do
      post charges_url, params: { charge: { extra_hour_charges: @charge.extra_hour_charges, min_charge: @charge.min_charge, min_hours: @charge.min_hours, vehicle_type: @charge.vehicle_type } }
    end
  ...
  test "should update charge" do
    patch charge_url(@charge), params: { charge: { extra_hour_charges: @charge.extra_hour_charges, min_charge: @charge.min_charge, min_hours: @charge.min_hours, vehicle_type: @charge.vehicle_type } }
